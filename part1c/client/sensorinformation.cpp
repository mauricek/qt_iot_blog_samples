...
SensorInformation::SensorInformation(QObject *parent) : QObject(parent)
{
    ...
    connect(m_fiveSecondTimer, &QTimer::timeout, [this]() {
        ...
        if (m_client->state() == QMqttClient::Connected) {
            ...
            m_client->publish(QLatin1String("qtds/active"), content.toUtf8());
        }
    });
...
void SensorInformation::setAmbientTemperature(double ambientTemperature)
{
    ...
    m_client->publish(QString::fromLatin1("qtds/%1/%2").arg(m_id).arg(SensorInformation::AmbientTemperature),
...
void SensorInformation::setObjectTemperature(double objectTemperature)
{
    ...
    m_client->publish(QString::fromLatin1("qtds/%1/%2").arg(m_id).arg(SensorInformation::ObjectTemperature),
...
void SensorInformation::setAccelerometerX(double accelerometerX)
{
    ...
    m_client->publish(QString::fromLatin1("qtds/%1/%2").arg(m_id).arg(SensorInformation::AccelerometerX),
...
void SensorInformation::setAccelerometerY(double accelerometerY)
{
    ...
    m_client->publish(QString::fromLatin1("qtds/%1/%2").arg(m_id).arg(SensorInformation::AccelerometerY),
...
void SensorInformation::setAccelerometerZ(double accelerometerZ)
{
    ...
    m_client->publish(QString::fromLatin1("qtds/%1/%2").arg(m_id).arg(SensorInformation::AccelerometerZ),
...
void SensorInformation::setAltitude(double altitude)
{
    ...
    m_client->publish(QString::fromLatin1("qtds/%1/%2").arg(m_id).arg(SensorInformation::Altitude),
...
void SensorInformation::setLight(double light)
{
    ...
    m_client->publish(QString::fromLatin1("qtds/%1/%2").arg(m_id).arg(SensorInformation::Light),
...
void SensorInformation::setHumidity(double humidity)
{
    ...
    m_client->publish(QString::fromLatin1("qtds/%1/%2").arg(m_id).arg(SensorInformation::Humidity),
